...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "automation_templates_team_public_idx" ON "automation_templates" USING btree ("team_id", "is_public");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "automation_templates_instance_id_idx" ON "automation_templates" USING btree ("instance_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "automation_templates_created_by_idx" ON "automation_templates" USING btree ("created_by");
