...
import { Check, Clock, Layers, MessageSquareText, SkipForward, Wand2, type LucideIcon } from 'lucide-react';
          ...
          return (
            <li key={item.key}>
              ...
              >
                ...
                {hecho && <Check className="size-3.5 shrink-0 text-emerald-600 dark:text-emerald-400" aria-hidden />}
