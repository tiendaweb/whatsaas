...
import { Bot, ExternalLink, KeyRound, Plug, Zap, type LucideIcon } from 'lucide-react';
...
const LEYENDA: Record<string, string> = {
  automatizacionesActivas: 'activas',
  funcionesActivas: 'habilitadas',
  conectoresActivos: 'activos',
  keysActivas: 'claves activas',
};

/**
 * Las apps que el hub de IA agrupa pero no reescribe.
 *
 ...
 */
export function SectoresDeApps({ apps }: { apps: ResumenIa['apps'] }) {
...
export function AppsView({ apps }: { apps: ResumenIa['apps'] }) {
