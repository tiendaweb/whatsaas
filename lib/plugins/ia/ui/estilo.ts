/**
 * Vocabulario visual del hub de IA: el mismo de Empresa, Marketing y el Command Center.
 *
 * Se copia y no se importa a propósito. `sales-ops/ui/hoy/estilo.ts` es el
 * vocabulario de ESA app; si el hub de IA lo importara, cualquier ajuste fino de una
