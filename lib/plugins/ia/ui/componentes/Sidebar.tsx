      ...
      <div className={cn('flex items-center gap-2.5 px-3 pt-4 pb-3', collapsed && 'justify-center px-0')}>
        ...
        {!collapsed && (
          <span className="min-w-0">
            <span className="block truncate text-sm font-semibold leading-tight">IA</span>
            <span className="block truncate text-[11px] leading-tight text-muted-foreground">Qué está prendido y con qué cuota</span>
          </span>
        )}
      </div>
...
const PREFERIDAS_MOVIL: Vista[] = ['inicio', 'agente', 'automatizaciones', 'funciones', 'banco'];
