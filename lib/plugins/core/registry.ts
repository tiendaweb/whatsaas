...
const pluginLoaders: Record<string, PluginLoader> = {
  ...
  empresa: () => import('@/lib/plugins/empresa/manifest'),
  marketing: () => import('@/lib/plugins/marketing/manifest'),
  ia: () => import('@/lib/plugins/ia/manifest'),
...
const pluginPermissionMap: Record<string, keyof Omit<MemberPermissions, 'chatVisibility'>> = {
  ...
  'empresa.read': 'empresaRead',
  'empresa.write': 'empresaWrite',
  'marketing.read': 'marketingRead',
  'marketing.write': 'marketingWrite',
  'ia.read': 'iaRead',
  'ia.write': 'iaWrite',
