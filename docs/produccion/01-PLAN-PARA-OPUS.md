...
5. ~~**`Enfoque.tsx` de Tareas OS** debería aceptar un pedido de producción: hoy hay dos relojes de 25 minutos.~~ ✅ 2026-09-07 (tanda 5): `Enfoque.tsx` usa `useBloqueProduccion` con la misma clave que Producción — un solo bloque, se pause donde se pause, sobrevive a cerrar y recargar. Lo que sigue (sesiones de trabajo persistidas y horas por pedido) está en `02-PLAN-AAPP-BUSINESS.md` §1.
